        ...
        for b = 1:numel(ICblocks)
            ...
            for isd = 1:numel(subsetdescs)
                if contains(subsetdescs{isd}, 'allbut')
                    ...
                    subsets2train{isd} = ~tempneugroup.(allbutstrsplit{end})(neu2anal);
                else
                    subsets2train{isd} = tempneugroup.(subsetdescs{isd})(neu2anal);
                end
            ...
            for isd = 1:numel(subsetdescs)
                ...
                if nnz(subsets2train{isd})==0
                    fprintf('%s Probe %s %s has no cortical neurons, skipping...\n', ...
                        mousedate, probes{iprobe}, subsetdescs{isd})
